...
public class TheAdsManager : MonoBehaviour
{
	...
	public void Init()
	{
		if (!this.bIsInit)
		{
			...
			if (this.bShowAdmobAds)
			{
				...
				MobileAds.Initialize(this.strAdmobAppID);
				this.RequestBanner();
				this.RequestInterstitial();
				this.RequestRewardedVideo();
				this.m_RewardedVideoAdmob.OnAdRewarded += new EventHandler<Reward>(this.HandleRewardBasedVideoRewarded);
			}
	...
	public void RequestBanner()
	{
		...
		{
			AdRequest request = new AdRequest.Builder().AddTestDevice(this.strTestDeviceAdmob).Build();
	...
	{
		this.m_RewardedVideoAdmob = RewardBasedVideoAd.Instance;
		if (this.bTestAdsAdmob)
		{
			AdRequest request = new AdRequest.Builder().AddTestDevice(this.strTestDeviceAdmob).Build();
			this.m_RewardedVideoAdmob.LoadAd(request, this.strAdmobRewardedVideoID);
		}
		else
		{
			AdRequest request2 = new AdRequest.Builder().Build();
			this.m_RewardedVideoAdmob.LoadAd(request2, this.strAdmobRewardedVideoID);
		}
	...
	{
		TheAdsManager._ReRequetsRewardVideo_c__Iterator2 _ReRequetsRewardVideo_c__Iterator = new TheAdsManager._ReRequetsRewardVideo_c__Iterator2();
		_ReRequetsRewardVideo_c__Iterator._time = _time;
		_ReRequetsRewardVideo_c__Iterator._this = this;
